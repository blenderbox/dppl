...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Season.go_live_date'
        db.add_column('theleague_season', 'go_live_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Season.go_dead_date'
        db.add_column('theleague_season', 'go_dead_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Season.go_live_date'
        db.delete_column('theleague_season', 'go_live_date')

        # Deleting field 'Season.go_dead_date'
        db.delete_column('theleague_season', 'go_dead_date')
    ...
    models = {
        ...
        'theleague.season': {
            ...
            'go_live_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '255', 'db_index': 'True'})
        },
