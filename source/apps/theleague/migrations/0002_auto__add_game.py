...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Game'
        db.create_table('theleague_game', (
            ...
            ('match', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['theleague.Match'])),
            ('player1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user1', to=orm['auth.User'])),
            ('player2', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user2', to=orm['auth.User'])),
        ))
        db.send_create_signal('theleague', ['Game'])


    def backwards(self, orm):
        
        # Deleting model 'Game'
        db.delete_table('theleague_game')
