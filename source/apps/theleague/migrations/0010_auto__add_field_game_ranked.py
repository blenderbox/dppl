...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Game.ranked'
        db.add_column('theleague_game', 'ranked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Game.ranked'
        db.delete_column('theleague_game', 'ranked')
