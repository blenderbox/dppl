...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Round.go_dead_date'
        db.alter_column('theleague_round', 'go_dead_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Round.go_live_date'
        db.alter_column('theleague_round', 'go_live_date', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'Round.go_dead_date'
        db.alter_column('theleague_round', 'go_dead_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Round.go_live_date'
        db.alter_column('theleague_round', 'go_live_date', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        'theleague.match': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'round': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['theleague.Season']"}),
