...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('theleague_match', 'date')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Match.date'
        raise RuntimeError("Cannot reverse this migration. 'Match.date' and its values cannot be restored.")
