...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Match.division'
        db.add_column('theleague_match', 'division', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['theleague.Division']), keep_default=False)

        # Adding field 'Season.league'
        db.add_column('theleague_season', 'league', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['theleague.League']), keep_default=False)

        # Changing field 'Season.go_live_date'
        db.alter_column('theleague_season', 'go_live_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2012, 3, 5)))


    def backwards(self, orm):
        
        # Deleting field 'Match.division'
        db.delete_column('theleague_match', 'division_id')

        # Deleting field 'Season.league'
        db.delete_column('theleague_season', 'league_id')

        # Changing field 'Season.go_live_date'
        db.alter_column('theleague_season', 'go_live_date', self.gf('django.db.models.fields.DateField')(null=True))
