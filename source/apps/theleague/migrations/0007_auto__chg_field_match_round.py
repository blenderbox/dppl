...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Match.round'
        db.alter_column('theleague_match', 'round_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['theleague.Round']))


    def backwards(self, orm):
        
        # Changing field 'Match.round'
        db.alter_column('theleague_match', 'round_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['theleague.Season']))
