...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Round.short_name'
        db.add_column('theleague_round', 'short_name', self.gf('django.db.models.fields.CharField')(default=1, max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Round.short_name'
        db.delete_column('theleague_round', 'short_name')
