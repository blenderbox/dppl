...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.include_in_team'
        db.add_column('accounts_profile', 'include_in_team', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profile.include_in_team'
        db.delete_column('accounts_profile', 'include_in_team')
    ...
    models = {
        'accounts.profile': {
            ...
            'include_in_team': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
