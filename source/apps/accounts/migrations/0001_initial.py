...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_profile', (
            ...
            ('rating', self.gf('django.db.models.fields.IntegerField')(default=1600)),
            ('twitter', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('facebook', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('linked_in', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ))
